...
open(unit=111,file='residual-lamda-e-2-geshi2-mesh1.dat')          !残差
       do i=1,time
...
open(unit=201,file='temp-lamda-e-2-geshi2-mesh1.txt')                   !温度
    do i=1,M+1
	  do j=1,N+1
...
subroutine temp_false                                   !假扩散
    use head
	integer:: i,j

open(unit=101,file='temp-lamda-e-1-geshi5-mesh1.txt')                   !乘方格式温度
open(unit=201,file='temp-lamda-e-2-geshi2-mesh1.txt')                   !假扩散格式温度
    do i=1,M+1
	  do j=1,N+1
 ...
 open(unit=301,file='false-expand2-mesh1.dat')                 !假扩散
