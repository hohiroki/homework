...
C---------INITIALIZE C-FIELDS
	...
	TE(I,J)=TEIN
	ED(I,J)=EDIN
	CPT(I,J)=(0.167*500.0+1173.0)*500.0
	T(I,J)=500.0
	YCH4(I,J)=0.03
	YO2(I,J)=0.23*0.97
	YN2(I,J)=0.77*0.97
...
c	IF(I.EQ.1.AND.J.LE.10)THEN
	...
	C(I,J)=0.0
	END IF
c	IF(I.EQ.1.AND.J.GE.11)THEN
c	TE(I,J)=0.0
c	ED(I,J)=0.0
c	CPT(I,J)=(0.167*1700+1173.0)*1700.0
c	T(I,J)=1700.0
c	YCH4(I,J)=0.0
c	YO2(I,J)=0.23*1.0
c	YN2(I,J)=0.77*1.0
...
c	IF(J.EQ.NJ)THEN
	...
	TE(I,J)=0.0
	ED(I,J)=0.0
	CPT(I,J)=(0.167*1700+1173.0)*1700.0
	T(I,J)=1700.0
	YCH4(I,J)=0.0
	YO2(I,J)=0.23*1.0
	YN2(I,J)=0.77*1.0
