...
class LBM2DQ9:
    ...
    def evolution(self):
        ...
        self.u = ne.evaluate("self.f[1] - self.f[3] + self.f[5] - self.f[6] - self.f[7] + self.f[8]")
        self.v = ne.evaluate("self.f[2] - self.f[4] + self.f[5] + self.f[6] - self.f[7] - self.f[8]")
